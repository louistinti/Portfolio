...
export const renault = {
  ...
  ui: {
    ...
    body: [
      "Le langage visuel suit le groupe : surfaces **gris sombre** et **jaune Renault** strictement en accent — états actifs, soulignés, surlignages. Le texte courant reste blanc cassé : du texte jaune sur gris sombre ne tient pas en petite taille.",
