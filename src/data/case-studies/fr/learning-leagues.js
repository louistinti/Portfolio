...
export const learningLeagues = {
  ...
  context: {
    eyebrow: 'Contexte',
    lede: "League of Legends est *brutal* à apprendre — j'ai construit le guide que j'aurais voulu avoir.",
    body: [
      "League of Legends est un jeu de 15 ans qui part du principe que vous savez déjà y jouer. Les nouveaux sont lâchés dans un 5v5 avec des centaines de champions, des systèmes denses et un mur de jargon communautaire — la plupart abandonnent avant le déclic.",
      ...
      "Le site est **en ligne et continue de grandir** — les cinq guides de rôle sont publiés, portés par un moteur que je peux étendre. Deux règles le gardent honnête : **pas de jargon** sans l'expliquer, et **pas de course à la méta** — j'enseigne la logique du jeu, pas le build du patch.",
    ],
    stats: [
